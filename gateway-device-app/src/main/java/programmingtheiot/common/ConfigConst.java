...
public class ConfigConst
{
	...
	public static final String AWS_IOT_KEY          = "awsIOTKey";
	public static final String AWS_PRIVATE_KEY      = "awsPrivateKey";
	public static final String AWS_CERT_KEY         = "awsCertKey";
	...
	public static final String UBIDOTS_LED_EVENT = "/v1.6/devices/actuator/led/lv";
	...
	public static final String SMTP_PROP_ENABLE_TLS_KEY = "mail.smtp.ssl.enable";
	...
	public static final String HUMIDITY_FLOOR = "humiditySimFloor";
	public static final String HUMIDITY_CEILING = "humiditySimCeiling";
	// constructors

	public static final String BASE_TOPIC_KEY = "baseTopic";
	
	public static final String UBIDOT_ACTUATOR = "/v1.6/devices/actuator/";
	public static final String UBIDOT_ACTUATOR_LED = UBIDOT_ACTUATOR + "led";
	
	public static final String CDA_SENSOR_TEMP = "temperature/";
	public static final String CDA_SENSOR_HUMID = "humidity/";
	public static final String CDA_SENSOR_PRESS = "pressure/";
	public static final String CDA_MEM_UTIL = "CDAmem";
	public static final String CDA_CPU_UTIL = "CDAcpu";
	public static final String GDA_MEM_UTIL = "GDAmem";
	public static final String GDA_CPU_UTIL = "GDAcpu";
