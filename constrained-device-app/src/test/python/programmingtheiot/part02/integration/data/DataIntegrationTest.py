...
class DataIntegrationTest(unittest.TestCase):
	...
	def testWriteActuatorDataToCdaDataPath(self):
		...
		dataObj  = ActuatorData(name = ConfigConst.HVAC_ACTUATOR_NAME, actuatorType=ActuatorData.HVAC_ACTUATOR_TYPE)
	...
	def testWriteSensorDataToCdaDataPath(self):
		...
		dataObj  = SensorData(name = ConfigConst.TEMP_SENSOR_NAME, sensorType=SensorData.TEMP_SENSOR_TYPE)
