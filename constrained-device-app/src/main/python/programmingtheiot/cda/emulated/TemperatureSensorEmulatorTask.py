...
class TemperatureSensorEmulatorTask(BaseSensorSimTask):
    """
    Shell representation of class for temperature sensor emulator task.
    ...
    def __init__(self, dataSet = None):
        ...
        super(TemperatureSensorEmulatorTask, self).__init__(sensorType=SensorData.TEMP_SENSOR_TYPE, minVal = SensorDataGenerator.LOW_NORMAL_INDOOR_TEMP, maxVal = SensorDataGenerator.HI_NORMAL_INDOOR_TEMP)
