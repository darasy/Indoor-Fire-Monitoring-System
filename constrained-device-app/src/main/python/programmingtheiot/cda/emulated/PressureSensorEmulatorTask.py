...
class PressureSensorEmulatorTask(BaseSensorSimTask):
    """
    Shell representation of class for pressure sensor emulator task.
    ...
    def __init__(self, dataSet = None):
        ...
        super(PressureSensorEmulatorTask, self).__init__(sensorType=SensorData.PRESSURE_SENSOR_TYPE, minVal = SensorDataGenerator.LOW_NORMAL_ENV_PRESSURE, maxVal = SensorDataGenerator.HI_NORMAL_ENV_PRESSURE)
